---
title: "Visualizations of Adult Autism Spectrum Disorder (ASD) Dataset"
---
...
<td align="center" valign="center">
```{r}
df.red <- mrp(data = sn.df[,-15], cl = factor(sn.df[,15]), nproj = 2)$projected_df
...
<td align="center" valign="center">
```{r}
df.red <- mrp(data = sn.df[,-15], cl = factor(sn.df[,15]), nproj = 3)$projected_df
