...
df <- sim_data[[1]]
overlap.map((2*overlap_mat_sim[[1]] - diag(3))*1000, lab.col = sim.palette, 
...
```{r}
df <- sim_data[[2]]
overlap.map((2*overlap_mat_sim[[2]] - diag(3))*100, lab.col = sim.palette, scale = expression("("%*%10^-2~")"), map.cex = 2.75, lab.cex = 4, legend.cex = 1.5, font = 2, scale.pos = 0.35, legend.width = 0.1)
```
<br />
...
```{r}
df <- sim_data[[3]]
overlap.map((2*overlap_mat_sim[[3]] - diag(3))*100, lab.col = sim.palette, scale = expression("("%*%10^-2~")"), map.cex = 2.75, lab.cex = 4, legend.cex = 1.5, font = 2, scale.pos = 0.35, legend.width = 0.1)
```
<br />
